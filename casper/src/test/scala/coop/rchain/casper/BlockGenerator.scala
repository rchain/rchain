...
trait BlockGenerator {
  ...
  def createBlock[F[_]: ChainState](parentsHashList: Seq[ByteString],
    ...
    createBlock(parentsHashList, creator, Seq.empty[Bond])
  def createBlock[F[_]: ChainState](parentsHashList: Seq[ByteString],
                                    creator: ByteString,
                                    bonds: Seq[Bond]): F[BlockMessage] =
    createBlock(parentsHashList, creator, bonds, HashMap.empty[ByteString, ByteString])
  def createBlock[F[_]: ChainState](
