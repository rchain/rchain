...
trait MergeabilityRules {
  ...
  val peekMergeabilityCases = List(
    ...
    "P! CX"   -> SamePolarityMerge(P0)(F1)(S0),
    "P! P!"   -> CouldMatchSameMerges(P0)(P1)(S0, S1),
    //"P! P!"   -> CouldMatchSameMerges(P_)(P_)(S0),
