...
object RecursiveFinalizer {
  ...
  /**
    * This Finalizer is a rewrite of old version which tries to recursively finalize LFB children.
    * That logic might lead to LFB stuck.
    * See [[Finalizer]] for new logic
    */
//  {
