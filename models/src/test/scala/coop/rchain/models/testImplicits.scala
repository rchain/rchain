...
object testImplicits {
  ...
  implicit val GUnforgeableArbitrary       = implicitly[Arbitrary[GUnforgeable]]
  implicit val GPrivateArbitrary           = implicitly[Arbitrary[GPrivate]]
  implicit val GDeployerAuthArbitrary      = implicitly[Arbitrary[GDeployerAuth]]
  ...
  implicit val GUnforgeableShrink       = implicitly[Shrink[GUnforgeable]]
  implicit val GPrivateShrink           = implicitly[Shrink[GPrivate]]
  implicit val GDeployerAuthShrink      = implicitly[Shrink[GDeployerAuth]]
