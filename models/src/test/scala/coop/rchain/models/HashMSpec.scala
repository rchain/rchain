...
// TODO After migration to scala 2.13 these tests fail, because MurmurHash3.productHash changed
//  (if (!ignorePrefix) h = mix(h, x.productPrefix.hashCode) was not there in 2.12).
//  Since we are going to implement custom management of Rholang objects, this test is commented out.
