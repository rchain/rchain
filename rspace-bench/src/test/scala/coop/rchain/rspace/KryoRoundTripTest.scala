...
// TODO this fails because tail is called on empty list somewhere during serialization.
//  This test is passing on https://github.com/RhonixLabs/rhonix/pull/23 but fails on
//  https://github.com/RhonixLabs/rhonix/pull/24, so something there changed behaviour.
//  For now comment this out since Kryo is not used anyway.
