...
wartremoverErrors ++= Seq(Wart.FinalCaseClass)
// ignore autogenerated sources from protobuf
// the issue is with clean project where there are no generated file yet
// wart will run in compile phase with scalaPB generating compile issues on the first run
// this is reported under https://github.com/wartremover/wartremover/issues/258
// hope it gets resolved soon
// there is also hope with https://scalapb.github.io/customizations.html
