...
/** Storage for messages that are received and stored but not replayed yet.
  * This is flat because it does not maintain any relation between messages in the buffer. */
object FlatCasperBufferKeyValueStorage {
