...
lazy val node = (project in file("node"))
  ...
  .settings(
    ...
    dockerBaseImage := sys.env.get("DOCKER_BASE_IMAGE").getOrElse("openjdk:8u171-jre-slim-stretch"),
    dockerCommands := {
    ...
    debianPackageDependencies in Debian ++= Seq(
      sys.env.get("DEBIAN_JRE_PKG").getOrElse("openjdk-8-jre-headless (>= 1.8.0.171)"),
