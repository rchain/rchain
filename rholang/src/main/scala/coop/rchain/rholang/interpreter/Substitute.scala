...
object Substitute {
  private[interpreter] def charge[A: Chargeable, M[_]: Sync: _cost: _bracket](
  ...
  def substituteAndCharge[A: Chargeable, M[_]: _cost: _bracket: Substitute[?[_], A]: Sync](
      term: A,
      depth: Int,
      env: Env[Par]
  ): M[A] =
  ...
  def substituteNoSortAndCharge[A: Chargeable, M[_]: _cost: _bracket: Substitute[?[_], A]: Sync](
      term: A,
      depth: Int,
      env: Env[Par]
  ): M[A] =
