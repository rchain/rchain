...
public class QGt extends Quantity {
  public final Quantity quantity_1, quantity_2;
  public QGt(Quantity p1, Quantity p2) { quantity_1 = p1; quantity_2 = p2; }

  public <R,A> R accept(coop.rchain.syntax.rholang.Absyn.Quantity.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof coop.rchain.syntax.rholang.Absyn.QGt) {
      coop.rchain.syntax.rholang.Absyn.QGt x = (coop.rchain.syntax.rholang.Absyn.QGt)o;
