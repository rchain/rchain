...
public class QEq extends Quantity {
  public final Quantity quantity_1, quantity_2;
  public QEq(Quantity p1, Quantity p2) { quantity_1 = p1; quantity_2 = p2; }

  public <R,A> R accept(coop.rchain.syntax.rholang.Absyn.Quantity.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof coop.rchain.syntax.rholang.Absyn.QEq) {
      coop.rchain.syntax.rholang.Absyn.QEq x = (coop.rchain.syntax.rholang.Absyn.QEq)o;
