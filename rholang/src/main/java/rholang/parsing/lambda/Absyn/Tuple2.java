...
public class Tuple2 extends Tuple {
  ...
  public Tuple2(TypedExpr p1, TypedExpr p2) { typedexpr_1 = p1; typedexpr_2 = p2; }

  public <R,A> R accept(rholang.parsing.lambda.Absyn.Tuple.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof rholang.parsing.lambda.Absyn.Tuple2) {
      rholang.parsing.lambda.Absyn.Tuple2 x = (rholang.parsing.lambda.Absyn.Tuple2)o;
