...
public class EPushPrompt extends Expr {
  ...
  public EPushPrompt(TypedExpr p1, TypedExpr p2) { typedexpr_1 = p1; typedexpr_2 = p2; }

  public <R,A> R accept(rholang.parsing.delimc.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof rholang.parsing.delimc.Absyn.EPushPrompt) {
      rholang.parsing.delimc.Absyn.EPushPrompt x = (rholang.parsing.delimc.Absyn.EPushPrompt)o;
