...
public class EBind extends Expr {
  public final TypedExpr typedexpr_1, typedexpr_2;
  public EBind(TypedExpr p1, TypedExpr p2) { typedexpr_1 = p1; typedexpr_2 = p2; }

  public <R,A> R accept(rholang.parsing.delimc.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof rholang.parsing.delimc.Absyn.EBind) {
      rholang.parsing.delimc.Absyn.EBind x = (rholang.parsing.delimc.Absyn.EBind)o;
