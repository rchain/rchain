...
2. Configure/fetch dependencies
    ...
    * BNFC - MUST be built from [git](https://github.com/BNFC/bnfc) b0252e5f666ed67a65b6e986748eccbfe802bc17 or later (even though BNFC found in your OS repository might match the version on github it may not work -- we higly recommend building from the source). If you use `cabal install` you will need to add your BNFC binary to the PATH.
    * Scala
