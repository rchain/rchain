...
def test_data_is_stored_and_served_by_node(command_line_options: CommandLineOptions, docker_client: DockerClient, random_generator: Random) -> None:
    with testing_context(command_line_options, random_generator, docker_client) as context:
        with docker_network_with_started_bootstrap(context=context) as bootstrap_node:
            ...
            bootstrap_node.deploy_contract_with_substitution({'@store_data@': random_data}, store_data_contract, '3596e2e5fd14b24a6d84af04b7f0a8f13e3e68ee2ca91dc4b19550f12e61502c')
            ...
            bootstrap_node.deploy_contract_with_substitution({'@id_address@': id_address}, read_data_contract, '3596e2e5fd14b24a6d84af04b7f0a8f13e3e68ee2ca91dc4b19550f12e61502c')
