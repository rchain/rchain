...
case class OpXmitTag(unwind: Boolean, next: Boolean, nargs: Int, lit: Int)     extends Op
case class OpXmitArg(unwind: Boolean, next: Boolean, nargs: Int, arg: Int)     extends Op
case class OpXmitReg(unwind: Boolean, next: Boolean, nargs: Int, reg: Int)     extends Op
case class OpXmit(unwind: Boolean, next: Boolean, nargs: Int)                  extends Op
case class OpXmitTagXtnd(unwind: Boolean, next: Boolean, nargs: Int, lit: Int) extends Op
case class OpXmitArgXtnd(unwind: Boolean, next: Boolean, nargs: Int, arg: Int) extends Op
case class OpXmitRegXtnd(unwind: Boolean, next: Boolean, nargs: Int, reg: Int) extends Op
...
case class OpApplyPrimReg(unwind: Boolean, next: Boolean, nargs: Int, primNum: Int, reg: Int)
    extends Op
case class OpApplyCmd(unwind: Boolean, next: Boolean, nargs: Int, primNum: Int) extends Op
...
case class OpXferLexToArg(indirect: Boolean, level: Int, offset: Int, arg: Int) extends Op
case class OpXferLexToReg(indirect: Boolean, level: Int, offset: Int, reg: Int) extends Op
