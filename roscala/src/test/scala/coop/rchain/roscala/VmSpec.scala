...
class VmSpec extends FlatSpec with Matchers {
  ...
  "OpApplyPrimTag" should "apply primitive function and copy result to the specified register" in {
  ...
  "OpLookupToArg" should "lookup binding in continuation when compiler can't find the compile-time binding for method." in {
