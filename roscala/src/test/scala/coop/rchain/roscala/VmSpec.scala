...
class VmSpec extends VmSpecUtils {
  ...
  override def runBehaviour[E: StrandPoolExecutor]: Unit = {
    ...
    "(if #t 1 2)" should "return 1" inBlock {
    ...
    "(if #f 1 2)" should "return 2" inBlock {
    ...
    "(block (+ 1 2) (+ 3 4))" should "return 3 or 7" inBlock {
    ...
    "(+ 1 (+ 2 (+ 3 4)))" should "return 10" inBlock {
    ...
    "(let [[x 1] [y 2]] (+ x y))" should "return 3" inBlock {
    ...
    "(let [[x #t]] (label l (if x (seq (set! x #f) (goto l)) 5)))" should "return 5" inBlock {
    ...
    "(let [[x #t]] (label l (if x (seq (set! x #f) (goto l)) x)))" should "return RblFalse" inBlock {
    ...
    "(+ 1.2 2.3)" should "return 3.5" inBlock {
    ...
    "(fx+ 1 (fx+ 2 3))" should "return 6" inBlock {
    ...
    "OpApplyPrimTag" should "apply primitive function and copy result to the specified register" inBlock {
    ...
    "OpApplyCmd" should "not change ctxt after running primitive" inBlock {
    ...
    "OpXmitReg" should "save the result of xmit function into the specified register for future use" inBlock {
    ...
    "OpXmitArg" should "save the result of the xmit function into the specified argument for future use" inBlock {
    ...
    "OpXmitTag" should "store the result of the xmit function into the specified location for future use" inBlock {
    ...
    "OpLookupToReg" should "lookup binding inBlock continuation when compiler can't find the compile-time binding for method." inBlock {
    ...
    "(+ (+ 1 2) (+ 3 4) (+ 5 6))" should "return 21" inBlock {
    ...
    "OpLookupToArg" should "lookup binding inBlock continuation when compiler can't find the compile-time binding for method." inBlock {
