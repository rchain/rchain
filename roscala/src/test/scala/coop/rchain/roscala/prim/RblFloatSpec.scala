...
class RblFloatSpec extends FlatSpec with Matchers {
  ...
  "flL(t" should "correctly return whether former smaller than latter" in {
    ...
    flLt.fn(newCtxt)(state, globalEnv) should be(RblBool(true))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2.1), Niv))
    flLt.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flLe" should "correctly return whether former smaller than or equal to latter" in {
    ...
    flLe.fn(newCtxt)(state, globalEnv) should be(RblBool(true))
  }

  it should "fail for non-fixnum arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2), Niv))
    flLe.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flGt" should "correctly return whether former greater than latter" in {
    ...
    flGt.fn(newCtxt)(state, globalEnv) should be(RblBool(true))
  }

  it should "fail for non-fixnum arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2.1), Niv))
    flGt.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flGe" should "correctly return whether former greater than or equal to latter" in {
    ...
    flGe.fn(newCtxt)(state, globalEnv) should be(RblBool(true))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2.1), Niv))
    flGe.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flEq" should "correctly return whether former equal to the latter" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2.2), RblFloat(2.2)))
    flEq.fn(newCtxt)(state, globalEnv) should be(RblBool(true))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(Fixnum(2), Niv))
    flEq.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flNe" should "correctly return whether former is not equal to latter" in {
    ...
    flNe.fn(newCtxt)(state, globalEnv) should be(RblBool(false))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(RblFloat(2), Niv))
    flNe.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flMin" should "correctly return the smallest input value" in {
    ...
    flMin.fn(newCtxt)(state, globalEnv) should be(RblFloat(2.1))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(2, Niv))
    flMin.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flMax" should "correctly return the greatest input value" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 4, Tuple(RblFloat(2.1), RblFloat(2.1), RblFloat(2.2)))
    flMax.fn(newCtxt)(state, globalEnv) should be(RblFloat(2.2))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(2, Niv))
    flMax.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flAbs" should "correctly return absolute value" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(-2.1)))
    flAbs.fn(newCtxt)(state, globalEnv) should be(RblFloat(2.1))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(1, Niv))
    flAbs.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flExp" should "correctly return e to the power of the input value" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(2.5)))
    flExp.fn(newCtxt)(state, globalEnv) should be(RblFloat(math.exp(2.5)))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flExp.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flExpt" should "correctly return first argument to the power of second argument" in {
    ...
    flExpt.fn(newCtxt)(state, globalEnv) should be(RblFloat(math.pow(2, .5)))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 2, Tuple(2, Niv))
    flExpt.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flLog" should "correctly return result of natural logarithm for input value" in {
    ...
    flLog.fn(newCtxt)(state, globalEnv) should be(RblFloat(1))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flLog.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flLog10" should "correctly return result of common logarithm for input value" in {
    ...
    flLog10.fn(newCtxt)(state, globalEnv) should be(RblFloat(2.0))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flLog10.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flCeil" should "correctly return ceiling of input value" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(2.1)))
    flCeil.fn(newCtxt)(state, globalEnv) should be(RblFloat(3.0))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flCeil.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flFloor" should "correctly return floor of input value" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(2.1)))
    flFloor.fn(newCtxt)(state, globalEnv) should be(RblFloat(2.0))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flFloor.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flAtan" should "correctly return the arc tangent of a value " in {
    ...
    flAtan.fn(newCtxt)(state, globalEnv) should be(RblFloat(Math.PI / 4))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flAtan.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
  ...
  "flSin" should "correctly return the trigonometric sine of an angle." in {
    ...
    flSin.fn(newCtxt)(state, globalEnv) should be(RblFloat(Math.sin(Math.PI)))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flSin.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }

  "flCos" should "correctly return the trigonometric cosine of an angle." in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(Math.PI)))
    flCos.fn(newCtxt)(state, globalEnv) should be(RblFloat(Math.cos(Math.PI)))
  }
  ...
  "flToFx" should "correctly convert the RblFloat value to Fixnum" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(RblFloat(2.1)))
    flToFx.fn(newCtxt)(state, globalEnv) should be(Fixnum(2))
  }

  it should "fail for non-RblFloat arguments" in {
    val newCtxt = reAssignCtxtArgs(ctxt, 1, Tuple(Niv))
    flToFx.fn(newCtxt)(state, globalEnv) should be(Deadthread)
  }
}
