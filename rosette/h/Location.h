...
#define GET_CTXTREG_INDEX(x) GET_LF(x,GENERIC_SIZE+CtxtRegExcessSize,CtxtRegIndexSize)

#define GET_ARGREG_INDEX(x) GET_LF(x,GENERIC_SIZE+ArgRegExcessSize,ArgRegIndexSize)

#define GET_LEXVAR_OFFSET(x)  GET_LF(x,GENERIC_SIZE,LexOffsetSize)
#define GET_LEXVAR_LEVEL(x)  GET_LF(x,GENERIC_SIZE+LexOffsetSize,LexLevelSize)
#define GET_LEXVAR_IND(x)  GET_LF(x,GENERIC_SIZE+LexOffsetSize+LexLevelSize,1)

#define GET_ADDRVAR_OFFSET(x)  GET_LF(x,GENERIC_SIZE,AddrOffsetSize)
#define GET_ADDRVAR_LEVEL(x)  GET_LF(x,GENERIC_SIZE+AddrOffsetSize,AddrLevelSize)
#define GET_ADDRVAR_IND(x)  GET_LF(x,GENERIC_SIZE+AddrOffsetSize+AddrLevelSize,1)

#define GET_GLOBALVAR_OFFSET(x) GET_LF(x,GENERIC_SIZE+GlobalExcessSize,GlobalOffsetSize)

#define GET_BITFIELD_SPAN(x) GET_LF(x,GENERIC_SIZE,BitFieldSpanSize)
#define GET_BITFIELD_OFFSET(x) GET_LF(x,GENERIC_SIZE+BitFieldSpanSize,BitFieldOffsetSize)
#define GET_BITFIELD_LEVEL(x) GET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize,BitFieldLevelSize)
#define GET_BITFIELD_SIGN(x) GET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize+BitFieldLevelSize,1)
#define GET_BITFIELD_IND(x) GET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize+BitFieldLevelSize+1,1)

#define GET_BITFIELD00_SPAN(x) GET_LF(x,GENERIC_SIZE,BitField00SpanSize)
#define GET_BITFIELD00_OFFSET(x) GET_LF(x,GENERIC_SIZE+BitField00SpanSize,BitField00OffsetSize)
#define GET_BITFIELD00_SIGN(x) GET_LF(x,GENERIC_SIZE+BitField00SpanSize+BitField00OffsetSize,1)
...
#define SET_CTXTREG_INDEX(x,val) SET_LF(x,GENERIC_SIZE+CtxtRegExcessSize,CtxtRegIndexSize,val)
#define SET_ARGREG_INDEX(x,val) SET_LF(x,GENERIC_SIZE+ArgRegExcessSize,ArgRegIndexSize,val)
#define SET_LEXVAR_OFFSET(x,val)  SET_LF(x,GENERIC_SIZE,LexOffsetSize,val)
#define SET_LEXVAR_LEVEL(x,val)  SET_LF(x,GENERIC_SIZE+LexOffsetSize,LexLevelSize,val)
#define SET_LEXVAR_IND(x,val)  SET_LF(x,GENERIC_SIZE+LexOffsetSize+LexLevelSize,1,val)
#define SET_ADDRVAR_OFFSET(x,val)  SET_LF(x,GENERIC_SIZE,AddrOffsetSize,val)
#define SET_ADDRVAR_LEVEL(x,val)  SET_LF(x,GENERIC_SIZE+AddrOffsetSize,AddrLevelSize,val)
#define SET_ADDRVAR_IND(x,val)  SET_LF(x,GENERIC_SIZE+AddrOffsetSize+AddrLevelSize,1,val)
#define SET_GLOBALVAR_OFFSET(x,val) SET_LF(x,GENERIC_SIZE+GlobalExcessSize,GlobalOffsetSize,val)
#define SET_BITFIELD_SPAN(x,val) SET_LF(x,GENERIC_SIZE,BitFieldSpanSize,val)
#define SET_BITFIELD_OFFSET(x,val) SET_LF(x,GENERIC_SIZE+BitFieldSpanSize,BitFieldOffsetSize,val)
#define SET_BITFIELD_LEVEL(x,val) SET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize,BitFieldLevelSize,val)
#define SET_BITFIELD_SIGN(x,val) SET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize+BitFieldLevelSize,1,val)
#define SET_BITFIELD_IND(x,val) SET_LF(x,GENERIC_SIZE+BitFieldSpanSize+BitFieldOffsetSize+BitFieldLevelSize+1,1,val)
#define SET_BITFIELD00_SPAN(x,val) SET_LF(x,GENERIC_SIZE,BitField00SpanSize,val)
#define SET_BITFIELD00_OFFSET(x,val) SET_LF(x,GENERIC_SIZE+BitField00SpanSize,BitField00OffsetSize,val)
#define SET_BITFIELD00_SIGN(x,val) SET_LF(x,GENERIC_SIZE+BitField00SpanSize+BitField00OffsetSize,1,val)

inline
int
operator == (Location loc1, Location loc2)
{
