...
/*
 * $Header: /mcc/project/carnot/root/master/pub-ess/h/sys/sysv4.h,v 1.1.1.1 1993/02/12 01:25:04 tomlic Exp $
 *
 * $Log: sysv4.h,v $
...
#define ARCH_DEFINE \
 Define("arch", SYMBOL("sun3")); Define("machine", SYMBOL("mc68020"));
