...
/*
 * $Header: /mcc/project/carnot/root/master/pub-ess/src/regexp.cc,v 1.1.1.1
...
static void regerror(char *err) { fprintf(stderr, "REGEXP error: %s\n", err); }
 ...
 */
int GS_regexec(register regexp *prog, register char *string) {
    register char *s;
