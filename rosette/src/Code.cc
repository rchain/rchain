...
CodeBuf::growCodevec (int sz)
{
	...
	CodeVec* newcodevec = CodeVec::create (SELF->codevec->numberOfWords() + sz);
	memcpy(&newcodevec->instr(0),
	       &SELF->codevec->instr(0),
...
void
CodeBuf::emitF0 (Opcode opcode, unsigned op)
{
    Instr i;
...
void
CodeBuf::emitF1 (Opcode opcode, unsigned op0, unsigned op1)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
    SET_OP_f1_op0(i,op0);
...
void
CodeBuf::emitF2 (Opcode opcode, unsigned op0, unsigned op1)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
    SET_OP_f2_op0(i,op0);
...
void
CodeBuf::emitF3 (Opcode opcode, unsigned op0, unsigned op1, unsigned op2)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
    SET_OP_f3_op0(i,op0);
...
void
CodeBuf::emitF4 (Opcode opcode, unsigned unwind, unsigned next, unsigned nargs, unsigned op0)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
...
void
CodeBuf::emitF5 (Opcode opcode, unsigned unwind, unsigned next, unsigned op0)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
...
void
CodeBuf::emitF6 (Opcode opcode, unsigned pc)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
    SET_OP_f6_pc(i,pc);
...
void
CodeBuf::emitF7 (Opcode opcode, unsigned indirect, unsigned level, unsigned offset, unsigned op0)
{
    Instr i;
    SET_OP_f0_opcode(i,opcode);
...
void
CodeBuf::emitE0 (unsigned op0, unsigned op1)
{
    Instr i;
    SET_OP_e0_op0(i,op0);
    SET_OP_e0_op1(i,op1);
...
void
CodeBuf::emitE2 (unsigned op0, unsigned op1)
{
  Instr i;
  Instr j;
  PROTECT_THIS(CodeBuf);
...
void
CodeBuf::patchAddress (int wordAddress, Word16 realAddress)
{
...
CodeVec*
CodeVec::create (int numberOfInstrs)
{
...
Instr*
CodeVec::dumpInstr (Instr* pc, char* buf, Code* code)
{
	...
	sprintf(buf, "outstanding %d,%d", (int) OP_f6_pc(insn), (int) OP_e0_op0((*pc++)));
	goto noDest;
	...
	sprintf(buf, "xmit%s%s %d,",
		OP_f4_unwind(insn) ? "/unwind" : "",
		OP_f4_next(insn) ? "/nxt" : "",
		OP_f4_nargs(insn));
	...
	sprintf(buf, "xmit%s%s %d,arg[%d]",
		OP_f4_unwind(insn) ? "/unwind" : "",
		OP_f4_next(insn) ? "/nxt" : "",
		(int) OP_f4_nargs(insn),
		(int) OP_f4_op0(insn));
	goto noDest;
	...
	if (prim_num == 255)
	  ...
	  sprintf(buf, "%s%s%s %d,",
		  SYMPTR(Prim::nthPrim(prim_num)->id),
		  OP_f5_unwind(insn) ? "/unwind" : "",
		  OP_f5_next(insn) ? "/nxt" : "",
		  (int) OP_f5_op0(insn));
	...
	sprintf(buf, "rtn%s arg[%d]", OP_f5_next(insn) ? "/nxt" : "", OP_f5_op0(insn));
	goto noDest;
	...
	goto noDest;
      ...
      case opJmpCut | 2:
      case opJmpCut | 3:
	sprintf(buf, "jmp/cut %d,%d", (int) OP_e0_op0((*pc++)), (int) OP_f6_pc(insn));
	goto noDest;
	...
	sprintf(buf, (OP_f7_indirect(insn)
		      ? "xfer lex[%d,(%d)],arg[%d]"
		      : "xfer lex[%d,%d],arg[%d]"),
		(int) OP_f7_level(insn),
		(int) OP_f7_offset(insn),
		(int) OP_f7_op0(insn));
	goto noDest;
	...
	sprintf(buf, (OP_f7_indirect(insn) ? "xfer lex[%d,(%d)]," : "xfer lex[%d,%d],"),
		(int) OP_f7_level(insn),
		(int) OP_f7_offset(insn));
	...
	goto formatDest;
      ...
      case opXferArgToArg:
	sprintf(buf, "xfer arg[%d],arg[%d]", (int) OP_f1_op1(insn), (int) OP_f1_op0(insn));
	goto noDest;
	...
	sprintf(buf, "lit %s,arg[%d]",
		immediateLitStrings[OP_f2_op0(insn)],
		(int) OP_f2_op1(insn));
	goto noDest;
...
void
CodeVec::dumpOn (FILE* f, Code* code)
{
...
Code*
Code::create (CodeVec* codevec, Tuple* litvec)
{
...
Code*
Code::create (CodeBuf* codebuf, Tuple* litvec)
{
    PROTECT(litvec);
...
Instr*
Code::dumpInstr (Instr* pc, char* buf)
{
...
MODULE_INIT(Code)
{
	...
	opcodeStrings[opXmitTagXtnd | NextOff | UnwindOn]  = "xmit/tag/unwind/xtnd";
	opcodeStrings[opXmitTagXtnd | NextOn  | UnwindOff] = "xmit/tag/nxt/xtnd";
	opcodeStrings[opXmitTagXtnd | NextOn  | UnwindOn]  = "xmit/tag/unwind/nxt/xtnd";
	opcodeStrings[opXmitArgXtnd | NextOff | UnwindOff] = "xmit/arg/xtnd";
	opcodeStrings[opXmitArgXtnd | NextOff | UnwindOn]  = "xmit/arg/unwind/xtnd";
	opcodeStrings[opXmitArgXtnd | NextOn  | UnwindOff] = "xmit/arg/nxt/xtnd";
	opcodeStrings[opXmitArgXtnd | NextOn  | UnwindOn]  = "xmit/arg/unwind/nxt/xtnd";
	opcodeStrings[opXmitRegXtnd | NextOff | UnwindOff] = "xmit/reg/xtnd";
	opcodeStrings[opXmitRegXtnd | NextOff | UnwindOn]  = "xmit/reg/unwind/xtnd";
	opcodeStrings[opXmitRegXtnd | NextOn  | UnwindOff] = "xmit/reg/nxt/xtnd";
	opcodeStrings[opXmitRegXtnd | NextOn  | UnwindOn]  = "xmit/reg/unwind/nxt/xtnd";
	...
	opcodeStrings[opApplyPrimTag | NextOff | UnwindOn]  = "applyprim/tag/unwind";
	opcodeStrings[opApplyPrimTag | NextOn  | UnwindOff] = "applyprim/tag/nxt";
	opcodeStrings[opApplyPrimTag | NextOn  | UnwindOn]  = "applyprim/tag/unwind/nxt";
	opcodeStrings[opApplyPrimArg | NextOff | UnwindOff] = "applyprim/arg";
	opcodeStrings[opApplyPrimArg | NextOff | UnwindOn]  = "applyprim/arg/unwind";
	opcodeStrings[opApplyPrimArg | NextOn  | UnwindOff] = "applyprim/arg/nxt";
	opcodeStrings[opApplyPrimArg | NextOn  | UnwindOn]  = "applyprim/arg/unwind/nxt";
	opcodeStrings[opApplyPrimReg | NextOff | UnwindOff] = "applyprim/reg";
	opcodeStrings[opApplyPrimReg | NextOff | UnwindOn]  = "applyprim/reg/unwind";
	opcodeStrings[opApplyPrimReg | NextOn  | UnwindOff] = "applyprim/reg/nxt";
	opcodeStrings[opApplyPrimReg | NextOn  | UnwindOn]  = "applyprim/reg/unwind/nxt";
