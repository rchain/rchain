...
/*
 * $Header: /mcc/project/carnot/root/master/pub-ess/src/unexhp9k800.c,v 1.1.1.1 1993/02/12 01:25:52 tomlic Exp $
 *
 * $Log: unexhp9k800.c,v $
 * Revision 1.1.1.1  1993/02/12  01:25:52  tomlic
...
#ifndef __RCS_ID__
#define __RCS_ID__
static const char *rcsid = "$Header: /mcc/project/carnot/root/master/pub-ess/src/unexhp9k800.c,v 1.1.1.1 1993/02/12 01:25:52 tomlic Exp $";
#endif
     ...
     int dummy1, dummy2;	/* not used by emacs */
{
  ...
  if ( old < 0)
       {perror("can't open in"); exit(1);}
  printf("(%d = old) \n",old);
  tem = fdopen(old,"r");
  setbuf(tem,stdin_buf);
  fflush(stdout);
  fclose(stdout);
