...
object BNFC {
  ...
  def bnfcGenerateSources(fullClasspath: Seq[Attributed[File]], grammarFile: File, outputDir: File, namespace: String): Unit = {
    ...
    val bnfcCmd: String   = s"/home/kirkwood/.cabal/bin/bnfc -l --java --jflex -o ${outputDir.getAbsolutePath} -p $namespace $grammarFile"
  ...
  def bnfcGenerateLaTeX(grammarFile: File, outputDir: File): Unit = {
    val bnfcCmd: String = s"/home/kirkwood/.cabal/bin/bnfc --latex -o ${outputDir.getAbsolutePath} $grammarFile"
    Process(bnfcCmd) !
  }
