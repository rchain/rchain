...
object Dependencies {
  ...
  val nettyBoringSsl      = "io.netty"                    % "netty-tcnative-boringssl-static" % "4.1.52.Final"
  val nettyTcnative       = "io.netty"                    % "netty-tcnative"            % "4.1.52.Final" classifier osClassifier
  val nettyTcnativeLinux  = "io.netty"                    % "netty-tcnative"            % "4.1.52.Final" classifier "linux-x86_64"
  val nettyTcnativeFedora = "io.netty"                    % "netty-tcnative"            % "4.1.52.Final" classifier "linux-x86_64-fedora"
